...
<div class="mobile about-contact-page hidden" id="AboutOurWork">
	<div class="mobilenav">
		<div class="mobile logo"><a href="#" onclick="_closeMenu(); return false;" class="mobile"><img src="<?php echo content_url(); ?>/themes/MagnaOpera/images/logo_magnaoperagroup.png" alt=""></a>
		</div>
