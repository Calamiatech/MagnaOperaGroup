...
<!-- Page Title
  ================================================== -->
    <div class="singleproject hidden"><div class="clear"></div><!-- For Stupid ie7-->
        <div class="full page">
            <div class="pagename">
        ...
        <div class="smallpage">
            ...
            <div class="content pagebg">
                <div class="contentwrap">
                    <?php the_content(); ?>
                    <div class="clear"></div>
                    <div class="watermark"><img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/images/watermarklogo.png"></div>
